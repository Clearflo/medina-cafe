...
export const businessInfo = {
  ...
  socialMedia: {
    ...
    instagram: 'https://instagram.com/medinacafe',
  }
};
...
export const testimonials = [
  {
    id: 't1',
    name: 'Sarah M.',
    comment: 'The sheesha here is the best in Calgary! Great flavors and excellent service.',
    rating: 5,
  },
  {
    id: 't2',
    name: 'Ahmed K.',
    comment: 'Authentic Middle Eastern food that reminds me of home. The lamb kebabs are amazing!',
    rating: 5,
  },
  {
    id: 't3',
    name: 'Jessica T.',
    comment: 'Love the atmosphere! Perfect place to relax with friends over good food and sheesha.',
    rating: 4,
  },
  {
    id: 't4',
    name: 'Michael R.',
    comment: 'Their baklava is to die for! And the Turkish coffee is the perfect finish to a meal.',
    rating: 5,
  }
];